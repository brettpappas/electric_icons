...
class ElectricIcons{
  ...
  static IconData v2 = IconData(0xE907, fontFamily: 'Electrical', fontPackage: 'electric_icons');

  static IconData h1 = IconData(0xE98B, fontFamily: 'Electrical', fontPackage: 'electric_icons');
